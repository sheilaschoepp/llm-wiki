---
name: reflect
description: "Creates a short, sampled compass note about the whole LLM knowledge base's direction, blind spots, overloaded notes, emerging clusters, and next research moves. Reads hot.md, index.md, recent log entries, prior reflections, and a stratified page sample; saves one dated note to 2-outputs/reflect/ and performs required hot.md/log.md bookkeeping. It never authors or promotes durable source, concept, entity, or synthesis pages. Use for whole-wiki questions about what the wiki is becoming or missing, what to read next for the research programme, what to sit with, which notes look overloaded, or requests to step back, take stock, and scan for blind spots. Not for topic-scoped orientation (brief), a specific research question (query), structural or semantic page checks (lint or audit), or synthesis-candidate discovery or drafting as the requested operation (synthesis); reflect may flag a candidate incidentally."
---
